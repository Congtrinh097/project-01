...
import { Upload, History, FileText, CheckCircle, AlertCircle, Trash2, FileEdit, Download, MessageCircle, Send } from 'lucide-react'
import { useQuery, useMutation, useQueryClient } from 'react-query'
import ReactMarkdown from 'react-markdown'
import { uploadCV, getCVs, getCV, deleteCV, generateResume, getResumes, downloadResume, deleteResume, sendChatMessage } from './services/api'
        ...
        <div className="border-t border-gray-200 bg-white p-4">
          <form onSubmit={handleSendMessage} className="flex items-end space-x-2">
            ...
            <button
              ...
              className="btn btn-primary px-6 py-3 h-fit flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
